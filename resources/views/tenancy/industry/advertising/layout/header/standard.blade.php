...
<header class="sticky top-0 z-40 bg-base-100 panel">
    <nav class="container px-8 mx-auto py-8">
        ...
        <div class="flex">
            <div class="grow">
                ...
                <div class="hidden md:flex items-center justify-between pr-4 lg:pr-8 h-12 text-sm text-gray-600">
                    ...
                    <div class="flex items-center gap-8">
                        <a href="/"
                           class="hidden md:inline-flex items-center gap-2 h-10 border-b border-transparent hover:border-secondary">
                            <span class="iconify size-4 text-secondary" data-icon="mdi-home"></span>
                            <span>Home</span>
                        </a>

                        <a href=" /customer-service"
                           class="hidden md:inline-flex items-center gap-2 h-10 border-b border-transparent hover:border-secondary">
                            <span class="iconify size-4 text-secondary" data-icon="mdi-headset"></span>
                        ...
                        @guest
                            <a href="/login"
                               class="hidden md:inline-flex items-center gap-2 h-10 border-b border-transparent hover:border-secondary">
                                <span class="iconify size-4 text-secondary" data-icon="mdi-user"></span>
                                <span>Log in</span>
                            </a>
                        @endguest
                ...
                <div class="pr-4 lg:pr-8 mt-4">
                    <div class="flex items-center justify-between gap-8">
                        <a href="/" class="inline-flex items-center shrink-0 h-8">
                        ...
                        <div class="flex flex-1 w-full">
                            ...
                            <div class="relative flex-1 flex">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     class="size-6 absolute right-0 mt-3 mr-3 pointer-events-none"
            ...
            <div class="flex flex-col-reverse gap-4">
                ...
                <a href="/cart"
                   class="inline-flex items-center justify-center h-12 w-full btn btn-secondary">
        ...
        @include('tenancy.industry.advertising.layout.utils.quicksearch.standard')
    </nav>
</header>
